        ...
        <MainContainer>
            ...
            <div className='grid gap-5 grid-cols-1 lg:grid-cols-3  '>
                <div className='flex flex-row lg:flex-col justify-center items-center'>
                    ...
                    <p className='lg:text-3xl  font-maven lg:text-center text-xl'>Safety Is Our Top Priority</p>
                ...
                <div className='flex flex-row-reverse lg:flex-col justify-center items-center'>
